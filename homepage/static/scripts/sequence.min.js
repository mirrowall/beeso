...
function defineSequence(a, b) {
  ...
  e = function(e, f) {
      ...
      function i(a, b) {
          var c;
          return a.currentStyle ? c = a.currentStyle[b] : document.defaultView && document.defaultView.getComputedStyle && (c = document.defaultView.getComputedStyle(a, "")[b]),
          c
      }
      function j(a, b, c) {
      ...
      function l(a) {
          var b, c;
          return c = a.indexOf("ms") > -1 ? 1 : 1e3,
          b = "0s" == a ? 0 : parseFloat(a.replace("s", "")) * c
      }
      function m(a, b) {
      ...
      function n(a, b) {
          var c, d, e;
          for (g(a) === !1 && (d = 1, a = [a]), d = a.length, e = 0; d > e; e++) c = a[e],
          m(c, b) === !1 && (c.className += (c.className ? " ": "") + b)
      }
      function o(a, b) {
          var c, d, e;
          for (g(a) === !1 ? (d = 1, a = [a]) : d = a.length, e = 0; d > e; e++) c = a[e],
          m(c, b) === !0 && (c.className = c.className.replace(new RegExp("(\\s|^)" + b + "(\\s|$)"), " ").replace(/^\s+|\s+$/g, ""))
      }
      function p(a, b) {
          var c = a.getBoundingClientRect(),
          d = !1;
          return b.clientX >= c.left && b.clientX <= c.right && b.clientY >= c.top && b.clientY <= c.bottom && (d = !0),
          d
      }
      function q(a, b, c) {
          ...
          if (a !== b) return c = b,
          q(a, b.parentNode, c);
          if (void 0 !== c) for (var d = c,
          e = a.getElementsByTagName(d.nodeName), f = e.length; f--;) if (d === e[f]) return f + 1
      }
      function r(a) {
          var c = 0,
          d = b.DIRECTION_NONE;
          return (void 0 !== a.left || void 0 !== a.right) && (c += 1),
      ...
      e.setAttribute("data-seq-enabled", d),
      d++;
      var u = {
          startingStepId: 1,
      ...
      y = function(a, b, c) {
          ...
          B = {}.hasOwnProperty;
          l = e(B, "undefined") || e(B.call, "undefined") ?
          function(a, b) {
          ...
          x.touch = function() {
              var c;
              return "ontouchstart" in a || a.DocumentTouch && b instanceof DocumentTouch ? c = !0 : A(["@media (", s.join("touch-enabled),("), p, ")", "{#modernizr{top:9px;position:absolute}}"].join(""),
              function(a) {
                  c = 9 === a.offsetTop
              }),
              c
      ...
      return B.ui = {
          ...
          getElements: function(a, b) {
              var c, d, e, f, g, h = [];
              for (d = document.querySelectorAll(b === !0 ? "." + this.defaultElements[a] : b), e = d.length, g = 0; e > g; g++) c = d[g],
              f = c.getAttribute("rel"),
              (null === f || f === B.$container.getAttribute("id")) && h.push(c);
              return h
          },
          show: function(a, b) {
          ...
          hide: function(a, b, c) {
              B.propertySupport.transitions === !0 ? (a.style[y.prefixed("transitionDuration")] = b + "ms", a.style[y.prefixed("transitionProperty")] = "opacity, " + y.prefixed("transform"), a.style.opacity = 0) : B.animationFallback.animate(a, "opacity", "", 1, 0, b),
              void 0 !== c && (B.hideTimer = setTimeout(function() {
                  c()
              },
              b))
          }
      ...
      B.autoPlay = {
          ...
          start: function(a, b) {
              ...
              var c = B.options;
              return a = this.getDelay(a, c.autoPlayDelay, c.autoPlayInterval),
              void 0 === b && B.started(B),
              n(B.$container, "seq-autoplaying"),
              n(B.$autoPlay, "seq-autoplaying"),
              c.autoPlay = !0,
              B.isAutoPlaying = !0,
              B.isAnimating === !1 && (B.autoPlayTimer = setTimeout(function() {
      ...
      B.canvas = {
          init: function() {
              void 0 !== B.$screen && (B.$screen.style.height = "100%", B.$screen.style.width = "100%"),
              B.canvas.getTransformProperties()
          },
          getSteps: function(a) {
              var b, c, d, e = [],
              f = a.children,
              g = f.length;
              for (B.stepProperties = {},
              d = 0; g > d; d++) c = f[d],
              b = d + 1,
              e.push(c),
              B.stepProperties[b] = {},
              B.stepProperties[b].isActive = !1;
              return e
          },
          getTransformProperties: function() {
              var a, b, c, d;
              for (a = 0; a < B.noOfSteps; a++) b = B.$steps[a],
              c = a + 1,
              d = {
                  seqX: 0,
                  seqY: 0,
              ...
              d.seqX += -1 * b.offsetLeft,
              d.seqY += -1 * b.offsetTop,
              B.stepProperties[c].canvasTransform = d
          },
          move: function(a, b) {
              if (B.options.animateCanvas === !0) {
                  var c, d = 0;
                  return b === !0 && B.firstRun === !1 && (d = B.options.animateCanvasDuration),
                  B.isFallbackMode === !1 && (c = B.stepProperties[a].canvasTransform, B.$canvas.style[y.prefixed("transitionDuration")] = d + "ms", B.$canvas.style[y.prefixed("transform")] = "translateX(" + c.seqX + "px) translateY(" + c.seqY + "px) translateZ(" + c.seqZ + "px) "),
                  !0
              }
              return ! 1
          },
          removeNoJsClass: function() {
              if (B.isFallbackMode !== !0) for (var a = 0; a < B.$steps.length; a++) {
                  ...
                  if (m(b, "seq-in") === !0) {
                      var c = a + 1;
                      B.animation.resetInheritedSpeed(c),
                      o(b, "seq-in")
                  }
              }
          }
      ...
      B.animation = {
          getPhaseProperties: function(a) {
              ...
              q = [];
              for (c = 0; j > c; c++) b = h[c],
              d = l(i(b, y.prefixed("transitionDuration"))),
              e = l(i(b, y.prefixed("transitionDelay"))),
              o.push(d),
              p.push(e),
              q.push(d + e),
              null !== b.getAttribute("data-seq") && (k.push(d), m.push(e), n.push(d + e));
          ...
          getPhaseThreshold: function(a, b, c, d) {
              var e = 0;
              return c === !0 && B.options.ignorePhaseThresholdWhenSkipped === !0 && (a = !0),
              void 0 === a && (b === !0 ? e = d: b !== !1 && (e = b)),
              e
          },
          ...
          manageNavigationSkip: function(a, b) {
              if (B.isFallbackMode !== !0) {
                  ...
                  if (B.ui.show(b, 0), B.options.navigationSkip === !0) {
                      if (B.navigationSkipThresholdActive = !0, 0 !== B.phasesAnimating && (clearTimeout(B.phaseThresholdTimer), clearTimeout(B.nextPhaseStartedTimer), B.options.fadeStepWhenSkipped === !0)) for (c = 1; c <= B.noOfSteps; c++) d = B.stepProperties[c],
                      d.isActive === !0 && c !== a && (e = B.$steps[c - 1], f = c, g = {},
                      g.id = f, g.element = e, B.phasesSkipped.push(g), B.animation.stepSkipped(e));
          ...
          stepSkipped: function(a) {
              B.ui.hide(a, B.options.fadeStepTime,
              function() {})
          },
          ...
          reverseProperties: function(a, b, c, d, e) {
              ...
              v = [];
              for (g = 0; q > g; g++) f = p[g],
              h = l(i(f, y.prefixed("transitionDuration"))),
              j = l(i(f, y.prefixed("transitionDelay"))),
              k = h + j,
              j = r.maxTotal - k,
              d !== !0 && (j += b),
              k = h + j,
              u.push(k),
              null !== f.getAttribute("data-seq") && v.push(k),
              e.reverseTimingFunctionWhenNavigatingBackwards === !0 && (s = i(f, y.prefixed("transitionTimingFunction")), t = o.reverseTimingFunction(s)),
              f.style[y.prefixed("transition")] = h + "ms " + j + "ms " + t;
              return m = Math.max.apply(Math, u),
              n = Math.max.apply(Math, v),
              setTimeout(function() {
                  o.domDelay(function() {
                      for (g = 0; q > g; g++) f = p[g],
                      f.style[y.prefixed("transition")] = ""
                  })
              },
              m + c),
              n
          ...
          forward: function(a, b, c, d, e) {
              var f, g, h, i = this;
              B.firstRun === !1 && i.currentPhaseStarted(B.currentStepId),
              o(c, "seq-out"),
              i.domDelay(function() {
                  f = i.startAnimateOut(B.currentStepId, b, 1),
                  g = f.watchedTimings.maxTotal,
                  h = i.getPhaseThreshold(d, B.options.phaseThreshold, B.isAnimating, g),
                  B.isAnimating = !0,
                  i.startAnimateIn(a, g, c, h, e)
              })
          },
          reverse: function(a, b, c, d, e) {
              ...
              n(c, "seq-out"),
              k.domDelay(function() {
                  g = k.getPhaseProperties(B.currentStepId, "current"),
                  h = k.getPhaseProperties(a, "next"),
                  l = k.getPhaseThreshold(d, B.options.phaseThreshold, B.isAnimating, g.timings.maxTotal),
                  f = k.getReversePhaseDelay(g.timings.maxTotal, h.timings.maxTotal, B.options.phaseThreshold, B.options.ignorePhaseThresholdWhenSkipped, B.isAnimating),
                  i = k.reverseProperties(g, f.current, 0, d, B.options),
                  j = k.reverseProperties(h, f.next, l, d, B.options),
                  k.startAnimateOut(B.currentStepId, b, -1, i),
                  B.isAnimating = !0,
                  B.firstRun === !1 && k.currentPhaseStarted(B.currentStepId),
                  k.startAnimateIn(a, i, c, l, e, j)
              })
          },
          startAnimateIn: function(a, b, c, d, e, f) {
              var g, h, i = this;
              B.prevStepId = B.currentStepId,
              B.currentStepId = a,
              B.firstRun === !0 && B.pagination.update(),
              B.firstRun === !1 || B.options.startingStepAnimatesIn === !0 ? (B.stepProperties[a].isActive = !0, B.nextPhaseStartedTimer = setTimeout(function() {
                  i.nextPhaseStarted(a, e)
              },
              d), B.phaseThresholdTimer = setTimeout(function() {
                  n(c, "seq-in"),
                  o(c, "seq-out"),
                  void 0 === f && (g = B.animation.getPhaseProperties(a, "next"), f = g.watchedTimings.maxTotal),
                  i.phaseEnded(a, "next", f, i.nextPhaseEnded),
                  h = i.getStepDuration(b, f, B.options.phaseThreshold),
                  B.stepEndedTimer = setTimeout(function() {
                      B.animation.stepEnded(a)
                  },
                  h)
              },
              d)) : (i.resetInheritedSpeed(a), B.phasesAnimating = 0, B.isAnimating = !1, B.options.autoPlay === !0 && B.autoPlay.start(!0), n(c, "seq-in"), o(c, "seq-out")),
              B.firstRun = !1
          },
          startAnimateOut: function(a, b, c, d) {
              var e, f = this;
              return 1 === c ? (o(b, "seq-in"), n(b, "seq-out"), e = f.getPhaseProperties(a, "current"), d = e.watchedTimings.maxTotal) : o(b, "seq-in"),
              B.firstRun === !1 && (B.stepProperties[a].isActive = !0, f.phaseEnded(a, "current", d, f.currentPhaseEnded)),
              e
          },
          ...
          nextPhaseStarted: function(a, b) {
              B.phasesAnimating++,
              void 0 === b && B.hashTags.update(),
              B.pagination.update(),
              B.nextPhaseStarted(a, B)
          },
          ...
          stepEnded: function(a) {
              B.isAnimating = !1,
              B.isAutoPlaying = !1,
              B.options.autoPlay === !0 && B.autoPlay.start(!0, !0),
              B.animationEnded(a, B)
          },
          ...
          reverseTimingFunction: function(a) {
              ...
              return d = [1 - b[2], 1 - b[3], 1 - b[0], 1 - b[1]],
              a = "cubic-bezier(" + d + ")"
          },
          resetInheritedSpeed: function(a) {
              if (B.isFallbackMode !== !0) {
                  ...
                  e = d.length;
                  for (c = 0; e > c; c++) b = d[c],
                  b.style[y.prefixed("transition")] = "0ms 0ms";
                  B.animation.domDelay(function() {
                      for (c = 0; e > c; c++) b = d[c],
                      b.style[y.prefixed("transition")] = ""
                  })
              }
          },
          ...
          getPropertySupport: function() {
              var a = !1,
              b = !1;
              return y.csstransitions === !0 && (a = !0),
              y.cssanimations === !0 && (b = !0),
              {
                  transitions: a,
                  animations: b
              }
      ...
      B.animationFallback = {
          animate: function(a, b, c, d, e, f, g) {
              if (a !== !1) {
                  ...
                  i = setInterval(function() {
                      ...
                      a.style[b] = d + j * (e - d) + c,
                      1 === j && (void 0 !== g && g(), clearInterval(i))
                  },
                  25);
                  a.style[b] = d + c
              }
          ...
          setupCanvas: function() {
              var a, b, c;
              if (B.isFallbackMode === !0) for (n(B.$container, "seq-fallback"), void 0 !== B.$screen && (B.$screen.style.overflow = "hidden", B.$screen.style.width = "100%", B.$screen.style.height = "100%"), B.$canvas.style.width = "100%", B.$canvas.style.height = "100%", this.canvasWidth = B.$canvas.offsetWidth, a = 0; a < B.noOfSteps; a++) b = B.$steps[a],
              c = a + 1,
              n(b, "seq-in"),
              b.style.width = "100%",
              b.style.height = "100%",
          ...
          moveCanvas: function(a, b, c, d) {
              if (d === !0) {
                  ...
                  g = 100,
                  h = 0; - 1 === c && (f = 100, g = -100),
                  this.animate(b, "left", "%", e, f, B.options.fallback.speed),
                  this.animate(a, "left", "%", g, h, B.options.fallback.speed)
              } else b.style.left = "-100%",
              a.style.left = "0"
          },
          goTo: function(a, b, c, d, e, f, g) {
              B.prevStepId = B.currentStepId,
              B.currentStepId = a,
              void 0 === g && B.hashTags.update(),
              B.pagination.update(),
              B.firstRun === !1 ? (this.moveCanvas(e, c, f, !0), B.isAnimating = !0, B.animationStarted(B.currentStepId, B), B.stepEndedTimer = setTimeout(function() {
      ...
      B.pagination = {
          ...
          update: function() {
              if (void 0 !== B.$pagination.elements) {
                  ...
                  if (void 0 !== B.$pagination.currentLinks) for (d = B.$pagination.currentLinks.length, a = 0; d > a; a++) c = B.$pagination.currentLinks[a],
                  o(c, "seq-current");
                  for (B.$pagination.currentLinks = [], b = 0; f > b; b++) c = B.$pagination.links[b][e],
                  B.$pagination.currentLinks.push(c),
                  n(c, "seq-current")
              }
      ...
      B.hashTags = {
          init: function(a) {
              if (B.options.hashTags === !0) {
                  var b, c;
                  B.hasPushstate = !(!window.history || !history.pushState),
                  c = location.hash.replace("#!", ""),
                  B.stepHashTags = this.getStepHashTags(),
                  "" !== c && (B.currentHashTag = c, b = this.hasCorrespondingStep(B.currentHashTag), b > -1 && (a = b + 1))
              }
              return a
          },
          ...
          getStepHashTags: function() {
              var a, b, c = [];
              for (a = 0; a < B.noOfSteps; a++) b = B.options.hashDataAttribute === !1 ? B.$steps[a].id: B.$steps[a].getAttribute("data-seq-hashtag"),
              c.push(b);
              return c
          },
          update: function() {
              if (B.options.hashTags === !0 && B.firstRun === !1 || B.options.hashTags === !0 && B.firstRun === !0 && B.options.hashChangesOnFirstStep === !0) {
                  ...
                  B.currentHashTag = B.stepHashTags[a],
                  "" !== B.currentHashtag && (B.hasPushstate === !0 ? history.pushState(null, null, "#!" + B.currentHashTag) : location.hash = "#!" + B.currentHashTag)
              }
          },
          setupEvent: function() {
      ...
      B.preload = {
          ...
          init: function(b) {
              if (B.options.preloader !== !1) {
                  ...
                  return n(B.$container, "seq-preloading"),
                  B.$preloader = B.ui.getElements("preloader", B.options.preloader),
                  i.append(),
                  i.addStyles(),
                  i.toggleStepsVisibility("hide"),
                  c = i.getImagesToPreload(B.options.preloadTheseSteps),
                  d = i.getImagesToPreload(B.options.preloadTheseImages, !0),
                  e = c.concat(d),
                  f = a(e),
                  f.on("always",
                  function() {
                  ...
                  f.on("progress",
                  function(a, b) {
                      h = b.isLoaded ? "loaded": "broken",
                      B.preloadProgress(h, b.img.src, g++, e.length, B)
                  }),
                  !0
              }
              return ! 1
          ...
          complete: function(a) {
              B.preloaded(B),
              B.options.pausePreloader !== !0 && (this.toggleStepsVisibility("show"), o(B.$container, "seq-preloading"), n(B.$container, "seq-preloaded"), n(B.$preloader[0], "seq-preloaded"), void 0 !== this.preloadIndicatorTimer && clearInterval(this.preloadIndicatorTimer), (y.prefixed("animation") === !1 || y.svg === !1) && (B.$preloader[0].style.display = "none"), void 0 !== a && a())
          },
          addStyles: function() {
          ...
          getImagesToPreload: function(a, b) {
              ...
              if (g(a) === !0) {
                  ...
                  if (b !== !0) for (d = 0; m > d; d++) for (f = B.$steps[d], h = f.getElementsByTagName("img"), i = h.length, e = 0; i > e; e++) j = h[e],
                  c.push(j);
                  else for (k = [], d = 0; m > d; d++) l = a[d],
                  k[d] = new Image,
                  k[d].src = l,
                  c.push(k[d])
              }
          ...
          toggleStepsVisibility: function(a) {
              if (B.options.hideStepsUntilPreloaded === !0) {
                  var b, c;
                  for (b = 0; b < B.noOfSteps; b++) c = B.$steps[b],
                  "hide" === a ? B.ui.hide(c, 0) : B.ui.show(c, 0);
                  return ! 0
              }
              return ! 1
          }
      ...
      B.manageEvents = {
          ...
          init: function() {
              return B.manageEvents.list[A] = [],
              B.options.hashTags === !0 && this.add.hashChange(),
              B.options.swipeNavigation === !0 ? this.add.swipeNavigation() : B.hammerTime = !1,
              B.options.keyNavigation === !0 && this.add.keyNavigation(),
              this.add.resizeThrottle(),
              this.add.pageVisibility(),
              B.options.nextButton !== !1 && (B.$next = B.ui.getElements("nextButton", B.options.nextButton), this.add.button(B.$next, "nav", B.next)),
              B.options.prevButton !== !1 && (B.$prev = B.ui.getElements("prevButton", B.options.prevButton), this.add.button(B.$prev, "nav", B.prev)),
              B.options.autoPlayButton !== !1 && (B.$autoPlay = B.ui.getElements("autoPlayButton", B.options.autoPlayButton), this.add.button(B.$autoPlay, "nav", B.toggleAutoPlay)),
              this.add.stopOnHover(),
              B.options.pagination !== !1 && (B.$pagination = {},
              B.$pagination.relatedElementId = d, B.$pagination.links = [], B.$pagination.elements = B.ui.getElements("pagination", B.options.pagination), this.add.button(B.$pagination.elements, "pagination")),
              null
          },
          ...
          add: {
              hashChange: function() {
                  ...
                  var a = function(a) {
                      var b, c;
                      b = a.newURL || location.href,
                      b = b.split("#!")[1],
                      B.currentHashTag !== b && (c = B.stepHashTags.indexOf(b) + 1, B.currentHashTag = b, B.goTo(c, void 0, void 0, !0))
                  };
                  return addHashChange(a),
                  B.manageEvents.list.hashchange.push({
                      element: window,
                      handler: a
                  }),
              ...
              button: function(a, b, c) {
                  ...
                  h === B.$container.id && null === e.getAttribute("data-seq-button") ? (e.setAttribute("data-seq-button", !0), f(e, h)) : null === h && null === e.getAttribute("data-seq-button") && f(e, h),
                  B.manageEvents.list.click.push({
                      element: e,
                      handler: d
                  });
              ...
              stopOnHover: function() {
                  ...
                  b = j(B.$container, "mousemove",
                  function(a) {
                      return a = a || window.event,
                      B.isTouched === !0 ? void(B.isTouched = !1) : void(p(B.$container, a) === !0 ? (B.options.autoPlayPauseOnHover === !0 && B.isMouseOver === !1 && B.autoPlay.pause(), B.isMouseOver = !0) : (B.options.autoPlayPauseOnHover === !0 && B.isMouseOver === !0 && B.autoPlay.unpause(), B.isMouseOver = !1))
                  }),
                  B.manageEvents.list.mousemove.push({
                      element: B.$container,
                      handler: b
                  }),
                  b = j(B.$container, "mouseleave",
                  function() {
                      B.options.autoPlayPauseOnHover === !0 && B.autoPlay.unpause(),
                      B.isMouseOver = !1
                  }),
              ...
              resizeThrottle: function() {
                  function a() {
                      setTimeout(function() {
                          B.canvas.getTransformProperties(),
                          B.propertySupport.transitions === !0 && B.canvas.move(B.currentStepId, !1)
                      },
                      500),
                      B.throttledResize(B)
                  }
      ...
      B.init = function(b) {
          ...
          B.isReady = !1,
          B.$container = b,
          B.$screen = B.$container.querySelectorAll(".seq-screen")[0],
          B.$canvas = B.$container.querySelectorAll(".seq-canvas")[0],
          B.$steps = B.canvas.getSteps(B.$canvas),
          B.noOfSteps = B.$steps.length,
          B.phasesAnimating = 0,
          B.phasesSkipped = [],
          s(B.$container, y),
          c = B.options.startingStepId,
          n(B.$container, "seq-active"),
          B.propertySupport = B.animation.getPropertySupport(),
          B.isFallbackMode = B.animation.requiresFallbackMode(B.propertySupport),
          B.canvas.init(c),
          B.canvas.removeNoJsClass(B),
          B.manageEvents.init(),
          B.autoPlay.init(),
          B.firstRun = !0,
          c = B.hashTags.init(c),
          1 === B.options.autoPlayDirection ? (e = c - 1, B.prevStepId = 1 > e ? B.noOfSteps: e) : (e = c + 1, B.prevStepId = e > B.noOfSteps ? 1 : e),
          B.currentStepId = B.prevStepId,
          d = B.prevStepId,
          B.animationFallback.setupCanvas(c),
          g = function() {
              B.animation.domDelay(function() {
                  B.animation.domDelay(function() {
                  ...
                  B.isReady = !0,
                  B.ready(B),
                  B.goTo(c, B.options.autoPlayDirection, !0)
              })
          },
      ...
      B.destroy = function() {
          var a, b, c;
          for (B.autoPlay.stop(), clearTimeout(B.autoPlayTimer), clearTimeout(B.phaseThresholdTimer), clearTimeout(B.stepEndedTimer), clearTimeout(B.currentPhaseEndedTimer), clearTimeout(B.nextPhaseStartedTimer), clearTimeout(B.nextPhaseEndedTimer), clearTimeout(B.fadeStepTimer), clearTimeout(B.hideTimer), clearTimeout(B.navigationSkipThresholdTimer), B.manageEvents.removeAll(B.manageEvents.list), o(B.$pagination.currentLinks, "seq-current"), o(B.$container, "seq-step" + B.currentStepId), o(B.$container, "seq-active"), B.$container.removeAttribute("style"), void 0 !== B.$screen && B.$screen.removeAttribute("style"), B.$canvas.removeAttribute("style"), a = 0; a < B.noOfSteps; a++) b = B.$steps[a],
          b.removeAttribute("style"),
          B.animation.resetInheritedSpeed(a + 1),
          o(b, "seq-in"),
          o(b, "seq-out");
          return c = B.$steps[B.options.startingStepId - 1],
          B.animation.resetInheritedSpeed(B.options.startingStepId),
          n(c, "seq-in"),
          e.removeAttribute("data-seq-enabled"),
          B.destroyed(B),
          B = null
      },
      B.next = function() {
      ...
      B.toggleAutoPlay = function(a) {
          return B.isAutoPlaying === !1 ? B.start(a) : B.stop(),
          B.isAutoPlaying
      },
      B.stop = function() {
          B.autoPlay.stop()
      ...
      B.goTo = function(a, b, c, d) {
          ...
          var e, f;
          return clearTimeout(B.autoPlayTimer),
          B.direction = b,
          1 === b ? o(B.$container, "seq-reversed") : n(B.$container, "seq-reversed"),
          e = B.$steps[B.currentStepId - 1],
          f = B.$steps[a - 1],
          B.animation.moveActiveStepToTop(e, f),
          B.animation.changeStep(a),
          B.isFallbackMode === !1 ? (B.animation.resetInheritedSpeed(a), (B.firstRun === !1 || B.firstRun === !0 && B.options.startingStepAnimatesIn === !0) && B.animationStarted(a, B), B.canvas.move(a, !0), B.animation.manageNavigationSkip(a, f), 1 === b ? B.animation.forward(a, e, f, c, d) : B.animation.reverse(a, e, f, c, d)) : B.animationFallback.goTo(a, B.currentStepId, e, a, f, b, d),
          !0
      },
      B.started = function() {},
      B.stopped = function() {},
